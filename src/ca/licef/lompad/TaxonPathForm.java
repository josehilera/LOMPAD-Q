...
class TaxonPathForm extends FormContainer {
    ...
    void addFormContent() {
        ...
        LangstringForm source = new LangstringForm("9.2.1", false, false, true);
    ...
    String toEvaluateFrame(String key) {
        //int subCat = Integer.parseInt(key.substring(5)) - 1;
        ...
        for (Enumeration e = vComponents.elements(); e.hasMoreElements();) {
            ...
            String res = ((FormWrapper) c).toEvaluateFrame(key);
            if (res != null)
                xml += res;
        }
