...
class EducationalForm extends FormContainer {
    ...
    void addFormContent() {
        ...
        //Environment
        EnvironmentForm environment = new EnvironmentForm("5.12", true, Util.greenIcon, false);
        environment.setIcon(Util.greenIcon);
        environment.addToggle();
        environment.addFormContent();
        addComponent(environment);
        
        //Tutoring
        TutoringForm tutoring = new TutoringForm("5.13", true, Util.greenIcon, false);
        tutoring.setIcon(Util.greenIcon);
        tutoring.addToggle();
        tutoring.addFormContent();
        addComponent(tutoring);
        
        //Learning Method
        VocabularyForm learningMethod = new VocabularyForm("5.14", true, false, null, true);
        learningMethod.setIcon(Util.greenIcon);
        learningMethod.addToggle();
        learningMethod.setAlignRight();
        learningMethod.addFormContent();
        addComponent(learningMethod);
        
        //Training Type
        VocabularyForm trainingType = new VocabularyForm("5.15", true, false, null, true);
        trainingType.setIcon(Util.greenIcon);
        trainingType.addToggle();
        trainingType.setAlignRight();
        trainingType.addFormContent();
        addComponent(trainingType);       
    }
