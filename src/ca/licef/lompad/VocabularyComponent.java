        ...
        if (isFilled()) {
            if (isLomVocabulary) {
                ...
                if (value.startsWith("Q")) 
                    source = Util.getLQMVocabularySource(value.substring(1, value.indexOf("-")));
                else if (value.startsWith("x")) //profile vocabulary
                    source = Util.getProfileVocabularySource(value.substring(1, value.indexOf("-")));                
                //if ((value.startsWith("Q5.14")) || (value.startsWith("Q5.14")) || (value.startsWith("Q5.14")) )                    
        ...
        if (isLomVocabulary) {
            ...
            try {
                if (child.getFirstChild() != null) {
                   // if (source.equals("LQMv1.0"))
                        //int pos = Util.getLQMPosVocabulary(value);
                    
                    int pos = source.equals("LQMv1.0") ? Util.getLQMPosVocabulary(value, path) : Util.getPosVocabulary(value, !source.equals("LOMv1.0"));
