 ...
 * @author usuario
 */
class EnvironmentForm extends FormContainer {    
    String rootNumber;
    ImageIcon icon;
    
    public EnvironmentForm(String title, boolean isLine, ImageIcon icon, boolean isMultiple) {
    ...
    void addFormContent(){        
        ...
        //Features
        VocabularyForm features = new VocabularyForm(rootNumber + ".1", true, true, new Object[]{null}, true);
        features.setIcon(icon);        
        features.addToggle();
        features.addFormContent();
        wrapper.addComponent(features);
        
        //Communication
        VocabularyForm communication = new VocabularyForm(rootNumber + ".2", true, true, new Object[]{null}, true);
        communication.setIcon(icon);        
        communication.addToggle();
        communication.addFormContent();
        wrapper.addComponent(communication);        
