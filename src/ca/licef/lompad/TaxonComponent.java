...
class TaxonComponent extends FormComponent {
    ...
    String toEvaluateFrame_Id(String key) {
        String xml = "";
        if (!jTextFieldId.getText().trim().equals(""))
            xml += "            ID: " + Util.convertSpecialCharactersForXML(jTextFieldId.getText().trim());
                    
        //if (xml.equals("")) xml = null;
        return xml;
    }

    String toEvaluateFrame_Entry() {
        String xml = "";
        ...
        if (!jTextFieldEntry.getText().trim().equals("")) {
            ...
            if (selectedItem != null && !"".equals(selectedItem))
                lang = " (" + selectedItem + ")";
            xml = Util.convertSpecialCharactersForXML(jTextFieldEntry.getText().trim()) + lang;
        }
        //if (xml.equals("")) xml = null;
        return xml;
    }    
