...
class GeneralForm extends FormContainer {
    ...
    void addFormContent() {
        ...
        LangstringForm title = new LangstringForm("1.2", true, false, true);
        ...
        //Demand
        LangstringForm demand = new LangstringForm("1.9", true, false, false);
        demand.setIcon(Util.greenIcon);
        demand.addToggle();
        demand.addFormContent();       
        addComponent(demand);        
        
        
        //Certification
        CertificationForm certification = new CertificationForm("1.10", true, Util.greenIcon, false);
        certification.setIcon(Util.greenIcon);
        certification.addToggle();
        certification.addFormContent();
        addComponent(certification);
    }    
