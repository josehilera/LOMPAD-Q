...
class TechnicalForm extends FormContainer {
    ...
    void addFormContent() {
        ...
        //Accessibility
        AccessibilityForm accessibility = new AccessibilityForm ("4.8", true, Util.greenIcon, false);
        accessibility.setIcon(Util.greenIcon);
        accessibility.addToggle();
        accessibility.addFormContent();
        addComponent(accessibility);
        
        //Usability
        UsabilityForm usability = new UsabilityForm ("4.9", true, Util.greenIcon, false);
        usability.setIcon(Util.greenIcon);
        usability.addToggle();
        usability.addFormContent();
        addComponent(usability);
    }
