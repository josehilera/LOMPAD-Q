...
class ControlValueMediator extends FormMediator {
     ...
     * Elle retire la valeur utilis#e par le nouveau composant
     * pour les prochaines entr#es. Elle notifie aussi les composants
     * existant de le retirer de leur liste.
     *
     * @param c     le composant venant d'etre cr##
    ...
    /**
     * Cette fonction fait la gestion des valeurs disponibles.
     * Elle r�introduit la valeur lib#r#e par le composant
     * pour les prochaines entr#es. Elle notifie aussi les composants
     * existant de la rajouter a leur liste.
     *
     * @param c     le composant venant d'etre supprim#, ou dont la comboBox vient d'etre modifi#e
